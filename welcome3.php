...
<html lang="en" dir="ltr">
  ...
  <body class="bg1">
    ...
    <button class="but" onclick="func1()"><b>Dock Details</b></button>
...
<br /><br />
  ...
  if(isset($_POST['show'])){
    ...
    if($res->num_rows>0){
      ...
      echo"<center><h1 style=\"color:yellow ;font-family: 'Courier New', monospace;\" >No Requests at the moment</h1> </center>";
    }
  }
   ?>
<br><br>
                ...
                if($ret->num_rows>0){
                  while($rowh=$ret->fetch_assoc()){
                    ...
                    if($reg->num_rows>0){
                      ...
                      // $from=
                      $txt="Dear".$_SESSION['username'].",your request for ship has been accepted kindly dock into dock no. ".$hs." Thank you";

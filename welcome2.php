    ...
    // echo $_SESSION["username"];
      if(isset($_POST['aw'])){
        ...
        if($res->num_rows>0){
          ...
          echo"<center><h1 style=\"color:yellow ;font-family: 'Courier New', monospace;\" >No Authorities</h1> </center>";
        }
      }
     ...
     if(isset($_POST['awp'])){
       $i=$_POST['namae6'];
       $t=$_POST['pass6'];
       $ao="UPDATE Authority SET Password='$t' where Username='$i'";
       if($con->query($ao)){
         echo"<script> alert('Password changed')</script>";
       }
       else{
         echo"<script> alert('Couldn't change the password')</script>";
       }
     }
